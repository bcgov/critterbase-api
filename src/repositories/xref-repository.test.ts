...
describe('xref-repository', () => {
  ...
  describe('getCollectionUnitsFromCategoryId', () => {
    ...
    it('should throw an error if no collection units are found', async () => {
      ...
      await expect(xrefRepository.getCollectionUnitsFromCategoryId(category_id)).rejects.toThrow(
        'Failed to find collection units.'
      );
  ...
  describe('getTsnCollectionCategories', () => {
    ...
    it('should throw an error if no collection categories are found', async () => {
      ...
      await expect(xrefRepository.getTsnCollectionCategories(456789)).rejects.toThrow(
        'Failed to find collection categories.'
      );
    });
  });
  ...
  describe('getTsnMarkingBodyLocations', () => {
    ...
    it('should throw an error if no marking body locations are found', async () => {
      ...
      await expect(xrefRepository.getTsnMarkingBodyLocations([123])).rejects.toThrow(
        'Failed to find marking body locations.'
      );
  ...
  describe('getTsnQualitativeMeasurements', () => {
    ...
    it('should throw an error if no qualitative measurements are found', async () => {
      ...
      await expect(xrefRepository.getTsnQualitativeMeasurements([123])).rejects.toThrow(
  ...
  describe('getQualitativeMeasurementOptions', () => {
    ...
    it('should throw an error if no qualitative measurements are found', async () => {
      ...
      await expect(xrefRepository.getQualitativeMeasurementOptions('bbbb')).rejects.toThrow(
  ...
  describe('getTsnQuantitativeMeasurements', () => {
    ...
    it('should throw an error if no collection units are found', async () => {
      ...
      await expect(xrefRepository.getTsnQuantitativeMeasurements([123])).rejects.toThrow(
