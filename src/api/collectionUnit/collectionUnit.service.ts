 ...
 */
const getCollectionUnitById = async (critter_collection_unit_id: string): Promise<critter_collection_unit | null> => {
 ...
 * @param {string} critter_collection_unit_id
 */
const getCollectionUnitByCritterId = async (critter_id: string): Promise<critter_collection_unit[]> => {
    return await prisma.critter_collection_unit.findMany({
      where: {
...
const createCollectionUnit = async (
    ...
    return await prisma.critter_collection_unit.create({ data: critter_collection_unit_data });
  };
   ...
   * @param {string} critter_collection_unit_id
   */
  const deleteCollectionUnit = async (critter_collection_unit_id: string): Promise<critter_collection_unit> => {
