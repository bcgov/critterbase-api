...
const measurementQuantitativeIncludeSubset =
...
const measurementQualitativeIncludeSubset =
...
type MeasurementQuantiativeSubsetType =
  Prisma.measurement_quantitativeGetPayload<
    typeof measurementQuantitativeIncludeSubset
  >;
type MeasurementQualitatitveSubsetType =
  Prisma.measurement_qualitativeGetPayload<
    typeof measurementQualitativeIncludeSubset
  >;
...
type MortalitySubsetType = Prisma.mortalityGetPayload<
  typeof mortalitySelectSubset
>;
...
type FormattedMortality = Omit<
  MortalitySubsetType,
  "location" | "lk_region_env" | "lk_region_nr" | "lk_wildlife_management_unit"
> & { mortality_location?: FormattedLocation };

type FormattedQuantitativeMeasurement = Pick<
  measurement_quantitative,
  "measured_timestamp" | "value"
> &
  Pick<xref_taxon_measurement_quantitative, "measurement_name" | "unit">;

type FormattedQualitativeMeasurement = Pick<
  measurement_qualitative,
  "measured_timestamp"
> &
